 ...
 */
export const responseOutputV2HotelFacilityTypeOutputDto = z.object({
  meta: meta.optional(),
 ...
 */
export const responseOutputV2HotelFacilityTypeOutputDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const responseOutputV2HotelFacilityTypeOutputDtoRequest = z
