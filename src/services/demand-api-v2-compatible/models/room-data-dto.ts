 ...
 */
export const roomDataDto = z.object({
 ...
 */
export const roomDataDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const roomDataDtoRequest = z
  .object({ roomId: z.number().nullish(), roomInfo: roomInfoDtoRequest.nullish() })
  .transform((data) => ({
    room_id: data['roomId'],
