...
export const scoreBreakdown = z.object({
  ...
  reviewerType1: z.string().optional(),
});
 ...
 */
export const scoreBreakdownResponse = z
  .object({
  ...
  .transform((data) => ({
    ...
    reviewerType1: data['reviewer_type'],
  }));
