 ...
 */
export const roomSizeDto = z.object({
 ...
 */
export const roomSizeDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const roomSizeDtoRequest = z.object({ metreSquare: z.number().nullish() }).transform((data) => ({
