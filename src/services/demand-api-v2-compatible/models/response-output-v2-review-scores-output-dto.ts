 ...
 */
export const responseOutputV2ReviewScoresOutputDto = z.object({
  meta: meta.optional(),
 ...
 */
export const responseOutputV2ReviewScoresOutputDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const responseOutputV2ReviewScoresOutputDtoRequest = z
