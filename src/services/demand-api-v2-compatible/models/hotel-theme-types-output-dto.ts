 ...
 */
export const hotelThemeTypesOutputDto = z.object({
 ...
 */
export const hotelThemeTypesOutputDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const hotelThemeTypesOutputDtoRequest = z
  .object({ themeId: z.number().nullish(), name: z.string().nullish() })
  .transform((data) => ({
