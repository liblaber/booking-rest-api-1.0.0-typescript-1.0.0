 ...
 */
export const responseOutputV2HotelThemeTypesOutputDto = z.object({
  meta: meta.optional(),
 ...
 */
export const responseOutputV2HotelThemeTypesOutputDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const responseOutputV2HotelThemeTypesOutputDtoRequest = z
