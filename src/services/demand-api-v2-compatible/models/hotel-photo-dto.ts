 ...
 */
export const hotelPhotoDto = z.object({
 ...
 */
export const hotelPhotoDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const hotelPhotoDtoRequest = z
  .object({ mainPhoto: z.boolean().nullish(), urlOriginal: z.string().nullish() })
  .transform((data) => ({
