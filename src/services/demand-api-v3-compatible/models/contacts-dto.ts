...
import { z } from 'zod';
import { contactDto, contactDtoRequest, contactDtoResponse } from '../../common/contact-dto';

/**
 * The shape of the model inside the application code - what the users use
 */
export const contactsDto = z.object({
 ...
 */
export const contactsDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const contactsDtoRequest = z
