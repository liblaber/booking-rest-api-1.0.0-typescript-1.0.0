...
import { z } from 'zod';
import { chargeDto, chargeDtoRequest, chargeDtoResponse } from '../../common/charge-dto';

/**
 * The shape of the model inside the application code - what the users use
 */
export const extraChargesDtoListChargeDto = z.object({
 ...
 */
export const extraChargesDtoListChargeDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const extraChargesDtoListChargeDtoRequest = z
  .object({
