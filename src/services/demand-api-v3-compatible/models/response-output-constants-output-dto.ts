 ...
 */
export const responseOutputConstantsOutputDto = z.object({
  data: z.any().optional(),
 ...
 */
export const responseOutputConstantsOutputDtoResponse = z
  .object({
    data: z.any().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const responseOutputConstantsOutputDtoRequest = z
