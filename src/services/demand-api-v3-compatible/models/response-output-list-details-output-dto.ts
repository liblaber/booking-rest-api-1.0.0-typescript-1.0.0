 ...
 */
export const responseOutputListDetailsOutputDto = z.object({
 ...
 */
export const responseOutputListDetailsOutputDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const responseOutputListDetailsOutputDtoRequest = z
  .object({
