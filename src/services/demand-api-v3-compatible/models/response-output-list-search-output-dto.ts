 ...
 */
export const responseOutputListSearchOutputDto = z.object({
 ...
 */
export const responseOutputListSearchOutputDtoResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const responseOutputListSearchOutputDtoRequest = z
  .object({
