 ...
 */
export const lazyTranslatedString = z.object({
 ...
 */
export const lazyTranslatedStringResponse = z
  .object({
    fallback: z.string().optional(),
  })
  .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const lazyTranslatedStringRequest = z.object({ fallback: z.string().nullish() }).transform((data) => ({
  fallback: data['fallback'],
}));
